...
alert_df = load_data('C:\\Users\\Public\\PythonCodes\\PythonTools\\LogAnalysis\\pages\\Monthly_alert_Logs_Data_202405.csv')
...
st.title('2024年5月 Alert レベルのルーターログのデータ')
...
st.subheader('Alert レベルの統計（前20位）')
st.text('全量データに基づいて、user, remip, reasonという3つのアイテムを統計した後に表示されます')
analysis_df = analysis_selected_dataframe(alert_df)
